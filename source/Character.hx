	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'cye':
				...
				frames = tex;
				animation.addByPrefix('idle', 'Cye IDLE', 12);
				animation.addByPrefix('singUP', 'Cye UP', 12);
				animation.addByPrefix('singRIGHT', 'Cye RIGHT', 12);
				animation.addByPrefix('singDOWN', 'Cye DOWN', 12);
				animation.addByPrefix('singLEFT', 'Cye LEFT', 12);
			...
			case 'bf-sad':
				var tex = Paths.getSparrowAtlas('sadbf');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
